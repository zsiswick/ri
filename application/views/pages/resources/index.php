  		...
  		<div class="columns large-12">
  			...
  			<ul>
  			  <li class="clearfix bottomSpc">
  			    <a href="http://www.site5.com/in.php?id=18181-54"
              ga-event-tracking
  	...
  	<div class="row">
        ...
        <ul>
          ...
          <li class="clearfix bottomSpc">
              ...
              event-category="Resources"
              event-action="view"
              event-label="affiliate: amazon - businessOfDesign"
              target="_blank">
              <img alt="The Business of Design" border="0" src="http://ecx.images-amazon.com/images/I/41Um5SPlm2L._SX399_BO1,204,203,200_.jpg" class="alignleft" style="width:120px"/>
            </a>
            <a href="http://amzn.to/1KP0qng"
              ga-event-tracking
              event-category="Resources"
              ...
              event-label="affiliate: amazon - businessOfDesign"
              target="_blank">
              <strong>The Business of Design</strong></a>: As a freelance designer, I can honestly say that most of my client work fell into my lap. When opportunity calls, it's easy to overlook a lot of critical details around writing up a proper design brief, proposal, and a contract. But without these critical components, life can easily become difficult to manage several months into a big project. This book helped me reduce my stress level by getting organized and becoming more business-like in my approach to handling freelance work. I highly recommend this one.
  			  </li>
          <li class="clearfix bottomSpc">
              ...
              target="_blank">
              <img border="0" src="https://d13yacurqjgara.cloudfront.net/users/5146/screenshots/1728012/code_school_dribbble4_teaser.png" class="alignleft" style="width:120px"/>
            </a>
            <a href="https://www.codeschool.com"
              ga-event-tracking
              event-category="Resources"
  	...
  	<div class="row">
        ...
        <ul>
          ...
          <li class="clearfix bottomSpc">
              ...
              target="_blank">
              <img alt="99designs" border="0" src="https://pbs.twimg.com/profile_images/459088066821361664/rY88nZrc_400x400.png" class="alignleft" style="width:120px"/>
            </a>
            <a href="http://99designs.com"
              ga-event-tracking
              event-category="Resources"
  ...
  <section class="content">
  	<div class="row">
        ...
        <ul>
              ...
              target="_blank">
              <img alt="Hello Fresh" border="0" src="https://www.hellofresh.com/images/hellofresh-logo.png" style="width:120px" class="alignleft"/></a>
              <a href="https://www.hellofresh.com"
                ga-event-tracking
                event-category="Resources"
                event-action="view"
