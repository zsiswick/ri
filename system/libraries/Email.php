...
class CI_Email {
	...
	var	$smtp_host		= "mail.rubyinvoice.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "hello@rubyinvoice.com";		// SMTP Username
	var	$smtp_pass		= "niccoluv";		// SMTP Password
